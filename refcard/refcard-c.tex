...
\usepackage{multicol,url,enumitem}
...
\begin{multicols}{3}
  ...
  \medskip\Subsection{Pré-processeur} (= cherche/remplace automatiques)\\
  ...
  \begin{Verbatim}[gobble=2,commandchars=+\[\]]
    ...
    switch (+textit[expression]) {
      ...
      case +textit[default]: +textit[instructions]+ldots
    }
  ...
  \smallskip\Subsection{Exemples de litéraux} (= valeurs de variables)
  \vspace{-.5\baselineskip}
  \begin{tabbing}
    ~~~\=\verb=123   -4   0xAf0C   057 = \= entiers (\verb=int=)\\
    \>\verb=3.14159265   1.29e-23=   \> réels (\verb=double=)\\
