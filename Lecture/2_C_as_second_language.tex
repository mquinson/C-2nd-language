...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Compiling multi-files projects and Makefiles}\subtoc
\begin{frame}{Compiling the code}
  \vspace{-.5\baselineskip}
  \begin{block}{One file, one pass}
    \begin{itemize}
    \item \fbox{\texttt{gcc -o binary source.c}} (beware of inversions,
  ...
  \begin{block}<2->{Several files, one pass}
    \begin{itemize}
    \item \fbox{\texttt{gcc -o binary source1.c source2.c source3.c}}
  ...
  \begin{block}<3->{Several files, several passes}
    ...
    \item \structure{Compilation:} 
      \fbox{\small\texttt{gcc -c source1.c}} 
      \fbox{\small\texttt{gcc -c source2.c}} 
      \fbox{\small\texttt{gcc -c source3.c}}\\
      {\small generates \texttt{source1.o, source2.o, source3.o}}
    \item \structure{Linking:} 
      \fbox{\small\texttt{gcc -o binary source1.o source2.o source3.o}}
    \item If only one file is touched, only recompile it, and relink everything
    \end{itemize}
  \end{block}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Dependency nightmare, make and Makefiles}
  \vspace{-.5\baselineskip}
  \begin{block}{Motivation}
    \begin{itemize}
