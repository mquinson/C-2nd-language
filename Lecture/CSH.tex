% ; whizzy -pdf .
%                                      
%\documentclass[10pt,prof,draft]{beamer}    % Version de travail, avec tout dessus
...
\def\logoesial{\includegraphics[height=2\baselineskip]{logo_esial_couleur.eps}}
\def\logoUHP{\includegraphics[height=1.5\baselineskip]{img/logo_nu.pdf}}
\def\shorttitle{Mastering your Linux: C / Shell (2013-2014)}

\title{Mastering your Linux: \\
  C and Shell Programming }
\author[\logoUHP~~~~~~Martin Quinson]{Martin Quinson \normalsize{$<$martin.quinson@loria.fr$>$}}
