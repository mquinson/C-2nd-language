...
%\noindent$\blacktriangleright$ \textit{Expérimentations avec la compilation
%  séparée.}
...
Vous: 3 3 6 1 2
  ...
  \Question Réalisez une fonction \run{int identifie(int hand[5])} permettant
...
%
  ...
  \Question Faites en sorte de permettre à l'utilisateur d'indiquer les dés
  qu'il souhaite relancer (comme on redemande une carte au Poker) en indiquant
  5 booléens après chaque lancé. Dans l'exemple suivant, les caractères
