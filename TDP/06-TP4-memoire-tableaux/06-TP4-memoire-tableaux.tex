...
Vous: 3 3 6 1 2
  ...
  5.  Vous utiliserez une fonction \run{void affiche(char *name, int
    hand[5])} pour afficher chaque ligne.
...
%
  ...
  \smallskip Nous voila prêts à modifier la fonction \texttt{affiche()} pour
